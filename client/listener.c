...
static void sigpipe_cb(evutil_socket_t sig, short events, void *user_data);
...
// Shutdown on sigint
static void sigint_cb(__attribute__((unused))evutil_socket_t sig, __attribute__((unused)) short events, void *user_data)
{
...
static void sigpipe_cb(__attribute__((unused)) evutil_socket_t sig, __attribute__((unused)) short events, __attribute__((unused)) void *user_data)
{
    LogInfo("listener", "Got SIGPIPE (recoverable?)");
}

// Shutdown on listener error
static void listener_default_error_cb(struct evconnlistener *listener, __attribute__((unused)) void *ctx)
{
